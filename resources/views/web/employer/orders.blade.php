                                    ...
                                    <tr>
                                      ...
                                      <td>
                                        <div class="profile-block">
                                          <img src="{{URL::to('/')}}/public/profile_img/{{$val->seller->profile_img}}" onerror="this.onerror=null;this.src='{{URL::to('/')}}/public/user-placeholder.jpg';">
                                          <h4>{{$val->seller->type == '3' ? $val->seller->company : $val->seller->fname.' '.$val->seller->lname}}</h4>
                                          <span class="label label-warning">{{$val->seller->type == '3' ? 'Agency' : 'Helper'}}</span>
                                        </div>
                                      </td>
